...
<figure><img src="../../../.gitbook/assets/image (4) (1).png" alt=""><figcaption><p>这张图片展示了OpenTelemetry的架构，包括API、SDK和Collector的工作流程。以下是对图片内容的详细介绍，帮助你更好地理解OpenTelemetry的工作原理。</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (5) (1).png" alt=""><figcaption><p>这张图片展示了Zipkin的工作流程和架构，通过追踪和记录请求在分布式系统中的流动情况来帮助开发者监控和诊断系统性能问题。</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (6) (1).png" alt=""><figcaption><p>这张图片展示了Jaeger的工作流程和架构，帮助我们理解如何使用Jaeger进行分布式追踪。为了更通俗易懂地介绍，我们可以将整个流程比作一个包裹物流系统。</p></figcaption></figure>
