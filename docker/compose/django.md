...
以上内容指定应用将使用安装了 Python 以及必要依赖包的镜像。更多关于如何编写 `Dockerfile` 文件的信息可以查看 [Dockerfile 使用](../basic\_concept/image/image/dockerfile/)。
...
查看 [`docker-compose.yml` 章节](compose\_file.md) 了解更多详细的工作机制。
